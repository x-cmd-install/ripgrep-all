...
[![x-cmd/install — ripgrep-all Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ripgrep-all.svg?lang=zh)](https://x-cmd.com/install/ripgrep-all)
...
合计: **3,761** 行代码（覆盖前 5 种语言、共 **34** 个文件）。
...
- **Star**: 9,855 · **Fork**: 218 · **开放 issue**: 227 · **贡献者**: 34

## 累计统计

- **发布数**: 12 · **已合并 PR**: 59 · **开放 PR**: 17 · **已关闭 issue**: 164 · **开放 issue**: 63 · **提交数**: 469

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 2 | 11 | 0 | 0 | 5 |
| last60d | 2026-07-26 | 0 | 2 | 11 | 1 | 0 | 5 |
| 90d | 2026-06-26 | 0 | 2 | 11 | 1 | 0 | 5 |
| last180d | 2026-03-28 | 0 | 2 | 11 | 1 | 5 | 5 |
| 360d | 2025-09-29 | 1 | 6 | 13 | 4 | 10 | 13 |
| last720d | 2024-10-04 | 3 | 15 | 14 | 14 | 32 | 52 |
...
_数据快照: `data/card/260924.yml` · 2026-09-24T04:51:49Z._
